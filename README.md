...
![Build](https://img.shields.io/badge/build-passing-brightgreen) ![AWS](https://img.shields.io/badge/AWS-12+_Services-orange) ![Status](https://img.shields.io/badge/status-live-brightgreen) ![License](https://img.shields.io/badge/license-MIT-blue) ![Serverless](https://img.shields.io/badge/serverless-Lambda_|_DynamoDB_|_SQS-purple) ![Auth](https://img.shields.io/badge/auth-AWS_Cognito-red)
...
⚠️ Note: The backend (AWS Lambda/API Gateway/DynamoDB) has been taken down to avoid ongoing AWS costs, so the live site will show "Failed to load products." Full functionality is demonstrated in the screenshots below, and the complete backend source code is available in this repository.

## 📸 Screenshots

| Home Page | Product Detail | Seller Dashboard |
|---|---|---|
| ![Home Page](screenshots/home.png) | ![Product Detail](screenshots/product.png) | ![Seller Dashboard](screenshots/seller-dashboard.png) |

| Add/Edit Product | Order Workflow | CloudWatch Alarms |
|---|---|---|
| ![Edit Product](screenshots/edit-product.png) | ![Step Functions](screenshots/step-functions.png) | ![CloudWatch](screenshots/cloudwatch.png) |
...
| 4 | AWS Lambda | 11 serverless backend functions |
...
| shopcloud-validate-order | Step Functions | Validates order fields |
| shopcloud-send-email | Step Functions | Sends confirmation email via SES |
| shopcloud-update-order-status | Step Functions | Updates order status to CONFIRMED |
